                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('orderan')}}"><span class="lable ml-0">Order Tiket</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <table class="table table-bordered table-striped mb-0 crudTable">
            ...
            <tbody>
                @foreach ( $orders as $order )
                    ...
                    <td><img src="{{asset('Upload/tiket/'.$order->tiket->image)}}" alt="" style="width:40px"></td>
                    <td>{{$order->tiket->name}}</td>
